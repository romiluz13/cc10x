...
DELTA_RULES: tuple[DeltaRule, ...] = (
    ...
    DeltaRule(
        ...
        (
            ...
            (
                ...
                "reviewer obeys router-owned internal skill precedence",
            ),
            (
                "Zero-Finding Gate",
                "reviewer must evidence scan coverage before a clean verdict",
            ),
        ),
    ),
    DeltaRule(
    ...
    DeltaRule(
        "plugins/cc10x/skills/frontend/SKILL.md",
        "internal-skill",
        (
            (
                "advisory",
