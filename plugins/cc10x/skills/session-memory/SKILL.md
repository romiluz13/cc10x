...
- `.cc10x/workflows/{wf}.json` and `.events.jsonl`: the durable orchestration
  truth
...
- editing `.cc10x/*.md` directly from a write agent
...
- [ ] No direct write-agent edits to `.cc10x/*.md`
