---
name: debug-workflow
description: Evidence-first debugging workflow. Use when investigating bugs, fixing errors, or troubleshooting issues. Follows LOG FIRST approach with root cause analysis.
