...
❌ **User asks: "Build todo app"**
**WRONG:** "Let me do security review first, then risk analysis, then deployment planning, then..."
**RIGHT:** "Building todo app directly. Done!"

❌ **User asks: "Fix this bug"**  
**WRONG:** "Let me analyze architecture, assess risks, create comprehensive plan..."
**RIGHT:** "Fixing the bug using LOG FIRST. Done!"

❌ **User asks: "Review security"**
**WRONG:** "Let me also do quality review, performance review, UX review..."
**RIGHT:** "Reviewing security as requested. Done!"

### The Rule:

**ONLY activate workflows/agents user explicitly requested!**

- Asked for "review" → ONLY review
- Asked for "build" → ONLY build (NO forced planning!)
- Asked for "plan and build" → NOW do both (they explicitly requested planning)
- Asked for "fix bug" → ONLY fix (NO architecture analysis!)

**If user wants more:**
- After delivering what they asked, OFFER additional help
- "Feature built! Want me to review it for security?"
- Let USER decide, don't force it

**Default mode: DIRECT EXECUTION. Full systematic ONLY if explicitly requested.**
