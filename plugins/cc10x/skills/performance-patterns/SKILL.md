...
**For detailed performance patterns and reference materials, see:**

- **PATTERNS.md**: Performance Pattern Library (Database, Algorithm, Frontend, Memory Leak, Caching Patterns), Performance Detection Commands, Performance Quick Checks
