...
## Enhanced: Detailed Implementation Plan Creation (Writing-Plans Pattern)

**Integration**: This section enhances Stage 5 with detailed task breakdown patterns from writing-plans skill.

**When to Use**: After architecture and risk analysis are complete, create detailed implementation plan with bite-sized tasks.
...
### Incremental Plan File Updates

**CRITICAL**: Update plan file incrementally as you create tasks:

1. **Create plan file**: `.claude/docs/plans/<feature-name>-plan.md`
2. **Add tasks incrementally**: After each task designed, add to plan file immediately
3. **Update after refinement**: If task changes, update plan file immediately
4. **Don't wait**: Write tasks as you design them, not at the end
...
[Tasks added incrementally as designed]
